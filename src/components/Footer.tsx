        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-slate-300 leading-relaxed">
              Your dedicated software development team. We build exceptional
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li className="text-slate-300">Cloud Solutions</li>
              <li className="text-slate-300">Data & Analytics</li>
              <li className="text-slate-300">Cybersecurity</li>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-slate-300">hello@techflow.com</span>
              </div>
            </div>
          </div>
        </div>
